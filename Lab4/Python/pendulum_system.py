...
class PendulumSystem(object):
    ...
    >>> parameters.L = 0.3 #: Refer to PendulumParameters for more info
    ...
    def pendulum_equation(self, theta, dtheta, time, torque):
        ...
        T_s1 = 0 #initialize springs and dampers as 0 torque
        T_s2 = 0
        D1 = 0
        D2 = 0
        
        if (s_theta_ref1 < theta):
            T_s1 = (s_theta_ref1-theta)*k1
            
        if (s_theta_ref2 > theta):
            T_s2 = (s_theta_ref2-theta)*k2
        
        T_spring = (T_s1+T_s2)/I
        ...
        pendulum_equation = -g * (1. / L) * sin(theta) + torque/I + T_spring + D #add springs and dampers
