...
class PendulumParameters(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.m = kwargs.pop("m", 2.)  # Mass
        self.L = kwargs.pop("L", 2.)  # Length
        self.d = kwargs.pop("d", .01)  # damping
...
def pendulum_equation(theta, dtheta, time=0, parameters=None, torque=0.):
    ...
    ddtheta =  -parameters.g/parameters.L*parameters.sin(theta)-parameters.d*dtheta
    ...
    if dry == True:
        ...
        ddtheta = -parameters.g/parameters.L*parameters.sin(theta)-parameters.d*sign
